  ...
  try{
    ...
    if(utilities.validator(payload, ['oldPassword', 'newPassword']).isValid){
      ...
      if(payload.oldPassword === adminObj.password){
        ...
        await email.send('entamarketltd@gmail.com', adminObj.email, `hello ${adminObj.username}, please verify your email with this OTP: ${newOtp}`, adminObj.username)
  ...
  try{
    ...
    if(utilities.validator(payload, ['email', 'password']).isValid){
      ...
      if(payload.password === adminObj.password){
        ...
        await email.send('entamarketltd@gmail.com', payload.email, `hello ${adminObj.username}, please verify your email with this OTP: ${newOtp}`, adminObj.username)
