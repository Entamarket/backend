    ...
    try{
      ...
      if(utilities.validator(payload, ['oldPassword', 'newPassword']).isValid){
        ...
        if(payload.oldPassword === logisticsObj.password){
          ...
          await email.send('entamarketltd@gmail.com', logisticsObj.email, `hello ${logisticsObj.username}, please verify your email with this OTP: ${newOtp}`, logisticsObj.username)
    ...
    try{
      ...
      if(utilities.validator(payload, ['email', 'password']).isValid){
        ...
        if(payload.password === logisticsObj.password){
          ...
          await email.send('entamarketltd@gmail.com', payload.email, `hello ${logisticsObj.username}, please verify your email with this OTP: ${newOtp}`, logisticsObj.username)
