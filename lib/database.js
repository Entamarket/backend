...
class Database{
    constructor(){
        ...
        this.collection = {
            ...
            entamarketAdmin: "entamarketAdmin",
            entamarketLogistics: "entamarketLogistics"
        };
        this.db;
    }
    connect = (cb)=>{
    ...
    checkForExistingUser = (data)=>{
        ...
        return new Promise((resolve) => {
            ...
            const searchPendingBuyers = pendingBuyers.findOne({$or: [{username: data.username}, {email: data.email}, {phoneNumber: data.phoneNumber}]})
            const searchBuyers = buyers.findOne({$or: [{username: data.username}, {email: data.email}, {phoneNumber: data.phoneNumber}]})
