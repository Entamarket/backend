    ...
    upload(req, res, (err)=>{
        if(err){
            ...
            if(req.files.length > 0){
                ...
                utilities.setResponseData(res, 400, {'content-type': 'application/json'}, {statusCode: 400, msg: 'no pictures added, make sure you add at least one picture of your product'}, true )
            }
